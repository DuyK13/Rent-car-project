...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        List<String> listEx = bindingResult.getAllErrors().stream().map(DefaultMessageSourceResolvable::getDefaultMessage).collect(Collectors.toList());
    ...
    public ResponseEntity<Object> handleNotFoundException(NotFoundException ex) throws JsonProcessingException {
        ...
        return new ResponseEntity<>(objectMapper.writeValueAsString(response), NOT_FOUND);
    }
